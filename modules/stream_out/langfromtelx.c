...
static int Open( vlc_object_t *p_this )
{
    ...
    var_Get( p_stream, SOUT_CFG_PREFIX "magazine", &val );
    p_sys->i_magazine = val.i_int;
    var_Get( p_stream, SOUT_CFG_PREFIX "page", &val );
    p_sys->i_page = val.i_int;
    var_Get( p_stream, SOUT_CFG_PREFIX "row", &val );
    p_sys->i_row = val.i_int;
...
static sout_stream_id_t * Add( sout_stream_t *p_stream, es_format_t *p_fmt )
{
    ...
    if ( p_fmt->i_codec == VLC_FOURCC('t','e','l','x') )
    {
